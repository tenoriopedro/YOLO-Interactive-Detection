...
def mouse_event(event, x, y, flags, params):
    ...
    try:
        ...
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            clicked_circle = (
                (x - circle_x1) ** 2 + (y - circle_y1) ** 2 <= radius ** 2
            )
            ...
            if ui_state['circle_clicked'] and (
                    not clicked_circle and not clicked_inside_popup):
        ...
        if ui_state['circle_clicked']:
            ...
            if 'area_1' in areas_by_index:
                ...
                if ui_state['cursor_over_link01'] and (
                        len(detected_classes) >= 1):
            ...
            if 'area_2' in areas_by_index:
                ...
                if ui_state['cursor_over_link02'] and (
                        len(detected_classes) >= 2):
            ...
            if 'area_3' in areas_by_index:
                ...
                if ui_state['cursor_over_link03'] and (
                        len(detected_classes) >= 3):
